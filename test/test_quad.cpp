...
namespace UnitTest
{
	...
	public:
		...
		TEST_METHOD(TestHit)
		{
			...
			// degenerate rays
			assertMiss(Quad(glm::vec3(1.f), glm::vec3(1.f), glm::vec3(2.f, -1.f, -1.f), dummyMaterial), Ray(), Interval::positive);
			assertMiss(
				Quad(glm::vec3(1.f), glm::vec3(1.f), glm::vec3(2.f, -1.f, -1.f), dummyMaterial),
